...
export const CASEWORKER_CASES: CaseworkerCase[] = [
  ...
  // Low-complexity cases below: high AI confidence, single or no evidence item,
  // P3/P4 priority, fully-verified individual ownership — eligible for auto-triage.
  {
    reference: 'HVCTS-2028-05011',
    property: {
      id: 'lyall-9', address: { line1: '9 Lyall Street', town: 'London', postcode: 'SW1X 8DS' },
      hvctsBand: 'H2', annualSurcharge: 18_400, effectiveDate: '1 April 2028',
      propertyType: 'terraced', estateType: 'freehold', ctBand: 'G', estimatedValue: 3_400_000,
      coordinates: { lat: 51.4975, lng: -0.1552 }, landRegistryRef: 'NGL774102',
      pad: { bedrooms: 4, bathrooms: 3, floorArea: 210, floorAreaUnit: 'sqm', garden: true, garage: 'none', propertyAge: 'Victorian (c.1860)', status: 'committed' },
      ownership: {
        nodes: [{ source: 'HM Land Registry', entity: 'David & Fiona Whitfield', role: 'Joint registered owners', detail: 'Registered since March 2012.', status: 'verified', date: '2012-03-09' }],
        confidence: 99, liableEntity: 'David & Fiona Whitfield', liableType: 'individual',
      },
      comparables: [], factors: [],
    },
    challengeType: 'Band dispute', priority: 'P3', priorityLabel: 'P3 Standard',
    tags: ['Band H2', 'Band Dispute', 'Individual Owner'], submittedDate: '4 days ago', status: 'new',
    aiConfidence: 91,
    evidence: [{ id: 'e8', fileName: 'comparable_sale.pdf', type: 'Comparable analysis', description: 'Nearby comparable sale', score: 88, strength: 'strong', aiAssessment: 'Comparable is consistent with the current band. No revision required.' }],
    aiSummary: 'Owner cites a nearby sale in support of a lower band, but the comparable is consistent with the current H2 valuation. No change warranted — recommend upholding the band with a brief explanation.',
  },
  {
    reference: 'HVCTS-2028-05023',
    property: {
      id: 'ovington-14', address: { line1: '14 Ovington Square', town: 'London', postcode: 'SW3 1LS' },
      hvctsBand: 'H3', annualSurcharge: 36_800, effectiveDate: '1 April 2028',
      propertyType: 'terraced', estateType: 'freehold', ctBand: 'H', estimatedValue: 6_100_000,
      coordinates: { lat: 51.4922, lng: -0.1656 }, landRegistryRef: 'NGL556231',
      pad: { bedrooms: 5, bathrooms: 4, floorArea: 300, floorAreaUnit: 'sqm', garden: true, garage: 'none', propertyAge: 'Victorian (c.1875)', status: 'committed' },
      ownership: {
        nodes: [{ source: 'HM Land Registry', entity: 'Priya Nair', role: 'Sole registered owner', detail: 'Registered since July 2019.', status: 'verified', date: '2019-07-22' }],
        confidence: 97, liableEntity: 'Priya Nair', liableType: 'individual',
      },
      comparables: [], factors: [],
    },
    challengeType: 'Liability dispute', priority: 'P4', priorityLabel: 'P4 Routine',
    tags: ['Band H3', 'Liability Dispute', 'Individual Owner'], submittedDate: '2 days ago', status: 'new',
    aiConfidence: 93,
    evidence: [], aiSummary: 'Owner queried why the notice named her rather than a former co-owner. Land Registry title confirms sole ownership since 2019 — the former co-owner was removed at that date. Straightforward explanation letter closes this.',
  },
  {
    reference: 'HVCTS-2028-05034',
    property: {
      id: 'redcliffe-22', address: { line1: '22 Redcliffe Square', town: 'London', postcode: 'SW10 9HP' },
      hvctsBand: 'H2', annualSurcharge: 18_400, effectiveDate: '1 April 2028',
      propertyType: 'flat-maisonette', estateType: 'leasehold', ctBand: 'G', estimatedValue: 2_900_000,
      coordinates: { lat: 51.4885, lng: -0.1885 }, landRegistryRef: 'NGL339045',
      pad: { bedrooms: 3, bathrooms: 2, floorArea: 155, floorAreaUnit: 'sqm', garden: false, garage: 'none', propertyAge: 'Victorian conversion', status: 'committed' },
      ownership: {
        nodes: [{ source: 'HM Land Registry', entity: 'Marcus Kelleher', role: 'Sole registered leaseholder', detail: '125-year lease from 2017.', status: 'verified', date: '2017-11-03' }],
        confidence: 98, liableEntity: 'Marcus Kelleher', liableType: 'individual',
      },
      comparables: [], factors: [],
    },
    challengeType: 'PAD correction', priority: 'P4', priorityLabel: 'P4 Routine',
    tags: ['Band H2', 'PAD Correction', 'Individual Owner'], submittedDate: 'Today', status: 'new',
    aiConfidence: 89,
    evidence: [{ id: 'e9', fileName: 'epc_certificate.pdf', type: 'EPC certificate', description: 'EPC floor area confirmation', score: 82, strength: 'strong', aiAssessment: 'EPC floor area matches PAD exactly — no correction needed.' }],
    aiSummary: 'Owner queried recorded floor area. EPC certificate confirms PAD figure is correct. No update required — case closed with explanation.',
  },
  {
    reference: 'HVCTS-2028-05045',
    property: {
      id: 'harcourt-3', address: { line1: '3 Harcourt Terrace', town: 'London', postcode: 'SW10 9JR' },
      hvctsBand: 'H1', annualSurcharge: 3_680, effectiveDate: '1 April 2028',
      propertyType: 'terraced', estateType: 'freehold', ctBand: 'F', estimatedValue: 2_150_000,
      coordinates: { lat: 51.4879, lng: -0.1802 }, landRegistryRef: 'NGL118820',
      pad: { bedrooms: 3, bathrooms: 2, floorArea: 175, floorAreaUnit: 'sqm', garden: true, garage: 'none', propertyAge: 'Victorian (c.1870)', status: 'committed' },
      ownership: {
        nodes: [{ source: 'HM Land Registry', entity: 'Emma & Oliver Grant', role: 'Joint registered owners', detail: 'Registered since Feb 2021.', status: 'verified', date: '2021-02-16' }],
        confidence: 96, liableEntity: 'Emma & Oliver Grant', liableType: 'individual',
      },
      comparables: [], factors: [],
    },
    challengeType: 'Band dispute', priority: 'P4', priorityLabel: 'P4 Routine',
    tags: ['Band H1', 'Band Dispute', 'Individual Owner'], submittedDate: '5 days ago', status: 'new',
    aiConfidence: 87,
    evidence: [{ id: 'e10', fileName: 'estate_agent_valuation.pdf', type: 'Estate agent valuation', description: 'Recent agent valuation', score: 71, strength: 'relevant', aiAssessment: 'Valuation is broadly consistent with the H1 threshold; no material discrepancy found.' }],
    aiSummary: 'Owner disputes being just above the £2M threshold. Agent valuation is consistent with the recorded value. No change warranted.',
  },
  {
    reference: 'HVCTS-2028-05056',
    property: {
      id: 'wilton-crescent-6', address: { line1: '6 Wilton Crescent', town: 'London', postcode: 'SW1X 8SE' },
      hvctsBand: 'H4', annualSurcharge: 73_600, effectiveDate: '1 April 2028',
      propertyType: 'terraced', estateType: 'freehold', ctBand: 'H', estimatedValue: 12_400_000,
      coordinates: { lat: 51.4995, lng: -0.1568 }, landRegistryRef: 'NGL904471',
      pad: { bedrooms: 6, bathrooms: 5, floorArea: 480, floorAreaUnit: 'sqm', garden: false, garage: 'single', propertyAge: 'Georgian (c.1840)', status: 'committed' },
      ownership: {
        nodes: [{ source: 'HM Land Registry', entity: 'Sir Anthony Chalfont', role: 'Sole registered owner', detail: 'Registered since 2005.', status: 'verified', date: '2005-09-12' }],
        confidence: 95, liableEntity: 'Sir Anthony Chalfont', liableType: 'individual',
      },
      comparables: [], factors: [],
    },
    challengeType: 'Liability dispute', priority: 'P3', priorityLabel: 'P3 Standard',
    tags: ['Band H4', 'Liability Dispute', 'Individual Owner'], submittedDate: '3 days ago', status: 'new',
    aiConfidence: 90,
    evidence: [], aiSummary: 'Query about whether liability should pass to a family member living at the property. Land Registry confirms sole ownership by Sir Anthony Chalfont — liability correctly attaches to the registered owner, not the occupier.',
  },
  {
    reference: 'HVCTS-2028-05067',
    property: {
      id: 'sloane-58', address: { line1: '58 Sloane Gardens', town: 'London', postcode: 'SW1W 8DG' },
      hvctsBand: 'H3', annualSurcharge: 36_800, effectiveDate: '1 April 2028',
      propertyType: 'flat-maisonette', estateType: 'leasehold', ctBand: 'H', estimatedValue: 5_600_000,
      coordinates: { lat: 51.4913, lng: -0.1548 }, landRegistryRef: 'NGL267819',
      pad: { bedrooms: 4, bathrooms: 3, floorArea: 260, floorAreaUnit: 'sqm', garden: false, garage: 'none', propertyAge: 'Edwardian conversion', status: 'committed' },
      ownership: {
        nodes: [{ source: 'HM Land Registry', entity: 'Charlotte Ferris', role: 'Sole registered leaseholder', detail: '199-year lease from 2015.', status: 'verified', date: '2015-04-30' }],
        confidence: 96, liableEntity: 'Charlotte Ferris', liableType: 'individual',
      },
      comparables: [], factors: [],
    },
    challengeType: 'PAD correction', priority: 'P3', priorityLabel: 'P3 Standard',
    tags: ['Band H3', 'PAD Correction', 'Individual Owner'], submittedDate: 'Today', status: 'in-progress',
    aiConfidence: 86,
    evidence: [{ id: 'e11', fileName: 'floor_plan_owner.pdf', type: 'Floor plan', description: 'Owner-submitted floor plan', score: 74, strength: 'relevant', aiAssessment: 'Owner floor plan is within 2% of PAD figure — variance too small to justify a band change.' }],
    aiSummary: 'Owner submitted a floor plan showing a small discrepancy against PAD (2%). Too small to affect banding — case closed, PAD unchanged.',
  },
  {
    reference: 'HVCTS-2028-05078',
    property: {
      id: 'egerton-31', address: { line1: '31 Egerton Terrace', town: 'London', postcode: 'SW3 2BX' },
      hvctsBand: 'H2', annualSurcharge: 18_400, effectiveDate: '1 April 2028',
      propertyType: 'terraced', estateType: 'freehold', ctBand: 'G', estimatedValue: 4_200_000,
      coordinates: { lat: 51.4964, lng: -0.1636 }, landRegistryRef: 'NGL482207',
      pad: { bedrooms: 4, bathrooms: 3, floorArea: 230, floorAreaUnit: 'sqm', garden: true, garage: 'none', propertyAge: 'Victorian (c.1865)', status: 'committed' },
      ownership: {
        nodes: [{ source: 'HM Land Registry', entity: 'Hassan & Layla Ibrahim', role: 'Joint registered owners', detail: 'Registered since Sept 2020.', status: 'verified', date: '2020-09-08' }],
        confidence: 94, liableEntity: 'Hassan & Layla Ibrahim', liableType: 'individual',
      },
      comparables: [], factors: [],
    },
    challengeType: 'Band dispute', priority: 'P4', priorityLabel: 'P4 Routine',
    tags: ['Band H2', 'Band Dispute', 'Individual Owner'], submittedDate: '6 days ago', status: 'new',
    aiConfidence: 85,
    evidence: [{ id: 'e12', fileName: 'zoopla_estimate.pdf', type: 'Online estimate', description: 'Online valuation estimate', score: 38, strength: 'weak', aiAssessment: 'Automated online estimates are not authoritative and do not support a band change on their own.' }],
    aiSummary: 'Owner cites an online valuation estimate below the band threshold. Online estimates are not authoritative evidence; recorded value stands. Case closed with explanation of evidence standards.',
  },
];
